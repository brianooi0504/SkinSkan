...
/// View controller class for the information screen where disease information are displayed
/// Second tab (index 1) for the root tab bar controller
class InformationViewController: UIViewController {
    // MARK: Variables
    /// Disease information saved as a static variable to be accessed anywhere
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        /// Reloads the TableView to display the updated disease information
        infoTableView.reloadData()
    }
    
    /// Prepares the disease selected and passes it to InformationDetailViewController through segue
...
extension InformationViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    /// Sets the number of rows in each TableView section according to number of diseases provided
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return InformationViewController.diseases.count
    }
    
    /// Configures each TableViewCell as InformationCell class instances using InformationCell identifier
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        /// Sets the background for the TableViewCell
